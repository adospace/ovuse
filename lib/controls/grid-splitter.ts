import { UIElement, FrameworkElement, Panel, XamlReader, Size, Rect,SizeToContent, FrameworkPropertyMetadataOptions, NavigationContext, Vector, Border, HorizontalAlignment, VerticalAlignment, Grid, GridRow, GridColumn, GridLength, GridUnitType, LayoutManager } from '.'
...
@TypeId("ovuse.Controls.GridSplitter")
export class GridSplitter extends Border {

    constructor() {
        super();
        FrameworkElement.classProperty.overrideDefaultValue(GridSplitter, "gridSplitter");
    }
