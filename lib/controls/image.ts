...
export class Image extends FrameworkElement {
    ...
    static srcProperty = DependencyObject.registerProperty(
        Image, "Source", null, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender);
    get source(): string {
    ...
    static stretchProperty = DependencyObject.registerProperty(
        Image, "Stretch", Stretch.None, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender, (v) => (<any>Stretch)[v]);
    get stretch(): Stretch {
    ...
    static stretchDirectionProperty = DependencyObject.registerProperty(
        Image, "StretchDirection", StretchDirection.Both, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender, (v) => (<any>StretchDirection)[v]);
